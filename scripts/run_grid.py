...
"""Run Grid-Guided Spatial Retrieval with Gemini."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max_retries", type=int, default=3, help="Maximum number of retries for failed API calls (default 3)")
...
def main(args: argparse.Namespace) -> None:
    ...
    if not api_key:
        raise RuntimeError("Set GEMINI_API_KEY in .env for Gemini access")
